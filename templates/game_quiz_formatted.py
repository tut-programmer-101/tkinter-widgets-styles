...
class gameApp(tk.Tk):
    ...
    def show_score_page_with_result(self, quiz_answers):
        ...
        # Then calculate the score and pass that into the frame of the ScorePage
        # Finally, show the ScorePage frame
...
class ScorePage(tk.Frame):
    def __init__(self, parent, controller):
        ...
        #self.result_message_label.grid(row=1,column=0)
        ...
        #back_to_intro.grid(row=2,column=0)
