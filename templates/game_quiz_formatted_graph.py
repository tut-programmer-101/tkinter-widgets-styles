# Matplotlib graph sourced from: matplotlib, Pie charts 
# Embedding matplotlib graph in Tkinter sourced from: GeeksforGeeks, How to embed Matplotlib charts in Tkinter GUI?
# Import libraries
import tkinter as tk
from tkinter import ttk
from tkinter.constants import * # For left, right, x, y etc 
## NEW ##
# Import matplotlib libraries (including for Tkinter)
...
class gameApp(tk.Tk):
    def __init__(self, *args, **kwargs):
        ...
        # Set the font size for Tkinter pages manually (as graph makes font smaller)
        page_font = tk.font.nametofont("TkDefaultFont")
        page_font.configure(size=20)
...
class MainPage(tk.Frame):
    def __init__(self, parent, controller):
        ...
        capital_entry = ttk.Entry(self, textvariable=self.capital_input_var, font=("Arial",16))
        ...
        species_label = ttk.Label(self, text="What species is a lizard?", font=("Arial",20))
...
class ScorePage(tk.Frame):
    def __init__(self, parent, controller):
        ...
        ## NEW ##
        # Make the Tkinter canvas with the matplotlib figure
        ...
        ## NEW##
        # Close all graphs to not affect the app's infinite main loop logic 
        plt.close('all')
        back_to_intro.grid(row=3,column=0,pady=20)
